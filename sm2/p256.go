...
type Sm2P256Curve struct {
	...
	*elliptic.CurveParams
	A_, B_, Gx_, Gy_ sm2P256FieldElement
}
...
func initP256Sm2() {
	...
	sm2P256.BitSize = 256
	sm2P256FromBig(&sm2P256.A_, A)
	sm2P256FromBig(&sm2P256.Gx_, sm2P256.Gx)
	sm2P256FromBig(&sm2P256.Gy_, sm2P256.Gy)
	sm2P256FromBig(&sm2P256.B_, sm2P256.B)
}
...
func (curve Sm2P256Curve) IsOnCurve(X, Y *big.Int) bool {
	...
	sm2P256Mul(&a, &curve.A_, &x) // a = a * x
	sm2P256Add(&x3, &x3, &a)
	sm2P256Add(&x3, &x3, &curve.B_)
